...
工作流文件：[`.github/workflows/deploy-gh-pages.yml`](https://github.com/koishi-shangxue-plugins/koishi-shangxue-apps/blob/docs/.github/workflows/deploy-gh-pages.yml)

### 手动触发
如需手动触发文档更新：

1. 访问 [GitHub Actions 页面](https://github.com/koishi-shangxue-plugins/koishi-shangxue-apps/actions/workflows/deploy-gh-pages.yml)
...
如有任何问题，欢迎通过 [Issues](https://github.com/koishi-shangxue-plugins/koishi-shangxue-apps/issues) 反馈或讨论！